            ...
            <div class="col-lg-12">
              <div class="shop-toolbar">
                ...
                <div class="product-page_count">
                  <p>Showing {products.length===0?0:firstIndex+1}–{lastIndex <=products.length ? lastIndex: products.length} of {products.length} results</p>
                </div>
                      ...
                      <div class="product-content">
                        <div class="product-desc_info">
                          ...
                          <div class="price-box">
                            ...
                            <span class="old-price">₹{product.actualprice}</span>
                          </div>
                          <div className="pt-1">
                            
                              {product.quantity>0?
                              (
                                <h6 className="text-success text-center">In Stock</h6>
                              ):(
                                <h6 className="text-danger text-center">Out of Stock</h6>
                              )}
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <ul class="kenne-pagination-box primary-color">
                          <li>
                            <a className="Prev" href="#" onClick={prePage}>Prev</a>
                          </li>
                          {/* <li class="active">
                            <a href="#">1</a>
                          </li> */}
                          {
                            numbers.map((n,i)=>(
                            <li class={`${currentPage === n ? 'active ' : ''}`} key={i}>
