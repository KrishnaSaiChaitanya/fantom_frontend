                      ...
                      <li className="minicart-wrap">
                        ...
                        >
                          <div
                            ...
                            role="button"
                          >                         
                            {getData.length ? <span className="item-count">{getData.length}</span> : <span></span>}
                  ...
                  <ul>
                    ...
                    <li className="megamenu-holder position-static">
                      ...
                      <ul className="kenne-megamenu">
                        ...
                        <li>
                          <span className="megamenu-title">Shop Related Pages</span>
                          <ul>
                            {/* <li>
                              <a href="my-account.html">My Account</a>
                            </li> */}
          ...
          >
            <div className="offcanvas-menu-inner p-1" style={{ width: "90%" }}>
                    ...
                    return(<>
                        <li className="minicart-product d-flex flex-row">
                          ...
                          >
                            ...
                            <span className="product-item_quantity">{e.quantity} x ₹{e.price}</span>
                          </div>
                          <Link className="product-item_remove" onClick={()=>dlt(e.id)}>
                            <i className="ion-android-close"></i>
                          </Link>
                        </li> 
                    </>)
              ...
              <div className="minicart-btn_area p-1">
                <Link to="/cart"  onClick={() => setis_mini_cart(!is_mini_cart)}
                    // data-bs-dismiss="offcanvas"
                    aria-label="Close" className="kenne-btn kenne-btn_fullwidth">
                  Minicart
                </Link>
              </div>
              <div className="minicart-btn_area p-1">
                <Link to="/checkout"  onClick={() => setis_mini_cart(!is_mini_cart)}
                    data-bs-dismiss="offcanvas"
                    aria-label="Close" className="kenne-btn kenne-btn_fullwidth">
                  Checkout
                </Link>
